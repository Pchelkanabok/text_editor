...
Омаровым Маратом Тимуровичем и Савастьяновой Александрой Васильевной
"""
...
class Window(QtWidgets.QMainWindow):
    ...
    def create_menu_bar(self):
        ...
        self.menubar.addAction('Font Style', self.action_font)

        self.menubar.addAction('Colour', self.action_colour)
    ...
    def action_save_as(self):
        """
        Функция обрабатывает нажатия на кнопки,
        отвечающие за сохранение файлов на устройстве в определенном фомате,
        и вызывает соответствующие команды
        Автор: Савастьянова А.В.
        Вход: сигнал о нажатии
        Выход: отсутствует
